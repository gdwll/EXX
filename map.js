...
/*var _tanahgarung = L.tileLayer.wms('http://localhost:8080/geoserver/tanah_garung/wms?',{
layers: 'garung:tanah_garung',
 transparent: 'true',
    format: 'image/png'
}).addTo(map);
var tanah_garung = L.tileLayer.wms('http://localhost:8080/geoserver/tanah_garung/wms?',{
layers: 'garung:tanah_garung',
 transparent: 'true',
    format: 'image/png'
}).addTo(map);*/
...
//overlays.addLayer(garung,'garung');
//overlays.addLayer(tanah_garung,'tanah_garung');
...
//layerControl.addOverlay(garung,"garung");
//layerControl.addOverlay(tanah_garung,"tanah_garung");
...
//L.control.layers.addOverlay(garung,"test").addTo(map);
layerControl.addBaseLayer(satellite,"satellite");
...
function info() {
    if (document.getElementById("info_btn").innerHTML == "☰ Informasi") {

        document.getElementById("info_btn").innerHTML = "☰ Sembunyikan";
        document.getElementById("info_btn").setAttribute("class", "btn btn-danger btn-sm");
        map.on('click', getinfo);
    } else {

        map.off('click', getinfo);
        document.getElementById("info_btn").innerHTML = "☰ Informasi";
...
function clear_all() {
    ...
    map.flyTo([-1.00, 120.00], 4);

    document.getElementById("query_panel_btn").innerHTML = "☰ Buka Project";
    ...
    document.getElementById("legend_btn").innerHTML = "☰ Legenda";
...
function show_hide_querypanel() {
	...
	document.getElementById("query_panel_btn").innerHTML = "☰ Sembunyikan";
...
function show_hide_legend() {
    ...
    if (document.getElementById("legend").style.visibility == "hidden") {
        ...
        document.getElementById("legend_btn").innerHTML = "☰ Sembunyikan";
